<?php
/**
 * Extending the AbstractFilter Class of Magento to override the Attribute class of Amasty for Mobile App
 * Making the change the _getItemsData function on line: 232 for checking the applied filters list.
 * filterapplied,getfilterapplied and getMultiselectValue are the additional custom functions.
 */
...
class Attribute extends AbstractFilter
{
    ...
    protected function _getItemsData()
    {
        ...
        if (in_array($attribute->getAttributeCode(),$this->getfilterapplied()) && !$this->getFilterSetting()->isUseAndLogic()) {
    ...
    public function filterapplied($activefil)
    {
	   $this->_activefil = $activefil;
	}
	
	public function getfilterapplied()
	{
	   return $this->_activefil;
	}
